...
public class TestArbolAVL extends TestCase {
	...
	{
		//se carga el primero de 2 escenarios(esta es de rotacion sencilla hacia izquierda)
		setUpEscenario1();
	...
	{
		//este test es de rotacion sencilla y doble, con un elemento repetido y una rotacion doble extrania
		setUpEscenario5();
		//se espera cierta altura , peso, y cantidad de balanceos(sencillos y dobles)
		assertEquals(4, arbol.getAltura());
		assertEquals(8, arbol.getPeso());
