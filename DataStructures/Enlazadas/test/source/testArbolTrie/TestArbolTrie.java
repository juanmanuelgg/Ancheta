...
public class TestArbolTrie extends TestCase {
	...
	public void testAgregar()
	{
		...
		assertEquals(7, arbol.getNumeroElemtos());
		//--------------------------[[ELEMENTO REPETIDO, MISMA POSICION]-----------------------
	...
	public void testBusquedaPorPefijo()
	{
		...
		//--------------------------ahora un elemento que esta bajo 2 nombres no deve aparecer 2 veces
		ClasePrueba aInsertar6= new ClasePrueba(6, "XXX::lolol");
		try{
	...
	public void testPalabraMasLarga(){
		//escenario planeado para que lapalabra maslarga este un poco mas anidada en el arbol que en el otro escenario
		setUpEscenario1_1();
